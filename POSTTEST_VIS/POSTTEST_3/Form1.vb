...
Public Class Form1
    ...
    Private Function CekData() As Boolean
        grupHobi = {cbGaming, cbBaca, cbBelanja, cbGambar, cbKaraoke, cbKebun, cbMasak, cbMusik, cbNulis, cbOlahraga}
        ...
        If Not ValidasiRadioButton(grupJK, "Pilih Jenis Kelamin Anda, Tidak Boleh Kosong") Then Return False
    ...
    Private Sub btnCetak_Click(sender As Object, e As EventArgs) Handles btnCetak.Click
        If CekData() Then
            ...
            DataModule.Telepon = txtTelpon.Text
    ...
    Private Sub btnGambar_Click(sender As Object, e As EventArgs) Handles btnFoto.Click
    ...
    End Sub
    Private Sub txtNim_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtUmur.KeyPress
