Module ValidationModule
    ...
    Public Sub HanyaAngkaDesimal(sender As Object, e As KeyPressEventArgs)
        If Not Char.IsControl(e.KeyChar) AndAlso Not Char.IsDigit(e.KeyChar) AndAlso e.KeyChar <> "."c Then
            e.Handled = True
        End If
        If e.KeyChar <> "."c AndAlso e.KeyChar <> ","c AndAlso CType(sender, TextBox).Text.Contains(".") AndAlso CType(sender, TextBox).Text.Contains(",") Then
            e.Handled = True
        End If
    End Sub
    ...
    Public Function ValidasiGroupCheckBox(grp As GroupBox, pesan As String) As Boolean
    ...
    Public Function ValidasiAnime(judul As String, genre As String,
                                  episode As String, studio As String,
                                  rating As String, photo As String,
                                  statusId As Integer) As Boolean
        ...
        If String.IsNullOrWhiteSpace(photo) Then
            MessageBox.Show("Photo belum dipilih", "Validasi gagal",
            MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End If
        If statusId = 0 Then
